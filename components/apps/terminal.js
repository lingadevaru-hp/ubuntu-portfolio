...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            root: ["projects", "skills", "languages", "education", "interests", "certifications", "personal-documents"],
            education: ["SIT_MCA_2024-2026", "Seshadripuram_BCA_2022-2024"],
            skills: ["Solana", "Ethereum", "Python", "JavaScript", "Rust", "Solidity", "QLoRA", "PEFT", "PyTorch", "Linux", "Docker"],
            projects: ["foss-coin", "thoshan-flash-llm", "insurance-claim-dapp", "network-adblock-router", "lingadevaru-hp.github.io"],
            interests: ["Blockchain Systems", "LLM Fine-Tuning", "AI Automation", "Web3", "Linux"],
            languages: ["Python", "JavaScript", "Solidity", "Rust"],
            certifications: ["Linux Fundamentals", "CS50_Introduction_to_Cybersecurity_(ongoing)"],
        };
        this.state = {
            terminal: [],
        }
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className=" text-ubt-green">lingadevaruhp@linux</div>
    ...
    handleCommands = (command, rowId) => {
        ...
        switch (main) {
            ...
            case "pwd":
                ...
                result = str.replace("~", "/home/lingadevaruhp")
                break;
            case "code":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("vscode");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-lingadevaru, trash, settings, sendmsg]";
                }
                break;
            case "echo":
            ...
            case "trash":
                ...
                break;
            case "about-lingadevaru":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("about-lingadevaru");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-lingadevaru, trash, settings, sendmsg ]";
                }
                break;
