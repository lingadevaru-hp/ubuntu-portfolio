...
export class Desktop extends Component {
    ...
    componentDidMount() {
        this.safePageView("/desktop", "Custom Title");
    ...
    safePageView = (page, title) => {
        try {
            ReactGA.send({ hitType: "pageview", page, title });
        } catch (_) { }
    }

    safeEvent = (category, action) => {
        try {
    ...
    checkContextMenu = (e) => {
        ...
        switch (e.target.dataset.context) {
            case "desktop-area":
                this.safeEvent(`Context Menu`, `Opened Desktop Context Menu`);
                this.showContextMenu(e, "desktop");
                break;
            default:
                this.safeEvent(`Context Menu`, `Opened Default Context Menu`);
    ...
    openApp = (objId) => {
        this.safeEvent(`Open App`, `Opened ${objId} window`);
